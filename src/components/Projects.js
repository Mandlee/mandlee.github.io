...
const projects = [
    ...
    {
        title: 'Sales demo #2',
        description: 'Siteubild (HTML5/SASS), React.js, jinja2',
        thumbnailImg: wuPrev,
    },
    {
        title: 'Sales demo #1',
    ...
    },
    {
        ...
        description: 'Siteubild (HTML5/SASS), Javascript/ES6, jinja2',
        thumbnailImg: amfamPrev,
    },
    {
        title: 'HBO GO',
        description: 'Siteubild (HTML5/SASS), Javascript/ES6, PHP, Gulp',
        thumbnailImg: goPrev,
    },
    {
        title: 'HBO Help Center',
        description: 'Siteubild (HTML5/SASS), VueJS',
        thumbnailImg: helpCenterPrev,
    },
    {
        title: 'Digital Dashboard',
        description: 'Siteubild (HTML5/SASS), AngularJS (ES6), D3JS',
        thumbnailImg: digitalPrev,
    },
    {
        title: 'Financial Dashboard',
        description: 'Siteubild (HTML5/SASS), AngularJS, D3JS',
    ...
    },
    {
        ...
        description: 'Siteubild (HTML5/CSS3), Bootstrap, Javascript, D3JS',
    ...
    },
    {
        ...
        description: 'Siteubild (HTML5/CSS3), Wordpress',
