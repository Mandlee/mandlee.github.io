            ...
            <ul className="timeline">
                <li>
                    ...
                    <div className="animated" data-animate-type="fadeInLeft">
                        ...
                        <p>
                            I'm currently working as a Frontend developer. My job consist of implementing new features
                            and maintaining existing websites for key customer in hospitality industry.
                        </p>
                    </div>
                </li>
                <li>
                    ...
                    <div className="animated" data-animate-type="fadeInRight">
                        <h3>Hearsay Systems</h3>
                        <h4 className="job-title">Senior Frontend Developer</h4>
                        <div className="date">Apr 2019 - Nov 2020</div>
                        <p>
                            I've worked as a Frontend developer on Sites product. Hearsay Sites is the easiest and
                            fastest way for creating beautiful and high converting agent websites for the financial
